 ...
 */
public final class MultiThreadLocationAdvancedFillStreamFilterLinux01 {
    /**
...
//        
        try{
        	...
        	int locatChose=1; //argv[1] //by bing, later to choose it. index from 0,1,2
        	String directPrefix="./data/";
