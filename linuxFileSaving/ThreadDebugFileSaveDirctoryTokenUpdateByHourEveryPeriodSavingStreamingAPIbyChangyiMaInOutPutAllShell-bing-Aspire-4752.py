...
class StdOutListener(StreamListener):
    ...
    def on_data(self, data):
        ...
        #if ((time.gmtime().tm_min-minuBing)<=20): # # change from tm_min-minuBing<=3,used debugging
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if loopCounter>=1:
            ...
            del auth # by bing ,to remove the things completely.
            del listener # by bing this is my added files
            del stream
            print("finish use del to delete stream,listener,auth"+"\n")
        ################by testing
